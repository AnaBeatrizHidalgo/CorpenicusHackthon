...
def create_professional_report(analysis_results, target_coords, bbox, area_size):
    ...
    ax_risk = fig.ax_sentinel.axis('off')
...
"""
COMO INTEGRAR COM O SCRIPT PRINCIPAL:

1. Adicionar ao final do script completo.py:

# Importar gerador de relatórios
from report_generator import create_professional_report, create_compact_infographic

# Após a análise combinada ser concluída:
...
2. Certificar-se de que as imagens estão disponíveis:
   - google_earth_raw.png
   - sentinel_processed.png
   - analise_combinada_dengue.png
